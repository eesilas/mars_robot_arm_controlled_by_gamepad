...
def on_forever():
    if pins.digital_read_pin(DigitalPin.P15) == 0:
        radio.send_value("F", pins.analog_read_pin(AnalogReadWritePin.P2))
        basic.show_leds("""
            . . # . .
            . # . # .
            # . # . #
        ...
        radio.send_value("B", pins.analog_read_pin(AnalogReadWritePin.P2))
        basic.show_leds("""
            . . # . .
            . . # . .
            # . # . #
        ...
        basic.show_leds("""
            ...
            . # # # .
            """)
    if pins.analog_read_pin(AnalogReadWritePin.P2) > 550 and (pins.analog_read_pin(AnalogReadWritePin.P1) > 400 and pins.analog_read_pin(AnalogReadWritePin.P1) < 600):
        radio.send_value("F", pins.analog_read_pin(AnalogReadWritePin.P2))
        basic.show_leds("""
            . . # . .
            . # . # .
        ...
        radio.send_value("L", pins.analog_read_pin(AnalogReadWritePin.P1))
        basic.show_leds("""
            . . # . .
            . # . . .
            # . # # #
        ...
        radio.send_value("R", pins.analog_read_pin(AnalogReadWritePin.P1))
        basic.show_leds("""
            . . # . .
            . . . # .
            # # # . #
